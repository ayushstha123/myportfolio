    ...
    return (
        ...
        <div className="bg-neutral-900 text-white min-h-screen pt-[50px] pb-[5px] lg:py-[100px]">
            <div className="h_container flex flex-col items-center px-2 pb-[20vw] lg:pb-[4vw]">
                <h1 className=" h_title  relative w-full text-center text-[15vw] font-extrabold  leading-[80%] lg:text-[8.7vw] ">
...
{/*                                                   
                ...
                <h1 className="h_title pt-8 relative w-full text-center text-[15vw] font-extrabold  leading-[80%] lg:text-[7.7vw] ">
                    <span className="-mb-1.5 -mt-6 inline-block overflow-hidden align-bottom">
                        <span className="inline-block  translate-y-full pb-1.5 pt-6 will-change-transform">
                            &nbsp;that  
                        </span>
        ...
        dark:[background:radial-gradient(circle_at_center,theme(colors.primary.900_/_85%),transparent)_-200%_50%_/_200%_100%_no-repeat,theme(colors.primary.100)] inline-block  translate-y-full pb-1.5 pt-6 will-change-transform">
                            &nbsp;loves  
                ...
                <h1 className=" h_title relative pt-5 w-full text-center text-[15vw] font-bold leading-[80%] lg:text-[8.7vw] ">
                    ...
                    <span className="-mb-1.5 -mt-6 inline-block overflow-hidden align-bottom">
                        <span className="font-light inline-block  translate-y-full pb-1.5 pt-6 will-change-transform">
                            &
                        </span>
                    </span>
                    <span className="-mb-1.5 -mt-6 inline-block overflow-hidden align-bottom">
        ...
        animate-shine !bg-clip-text text-transparent 
        [background:radial-gradient(circle_at_center,theme(colors.primary.100_/_85%),transparent)_-200%_50%_/_200%_100%_no-repeat,theme(colors.primary.800)]
        dark:[background:radial-gradient(circle_at_center,theme(colors.primary.900_/_85%),transparent)_-200%_50%_/_200%_100%_no-repeat,theme(colors.primary.100)]  font-extrabold  inline-block  translate-y-full pb-1.5  pt-6  leading-[81%] will-change-transform ">
                            <Image src={brain}  
                            width={100}
                            height={100}
